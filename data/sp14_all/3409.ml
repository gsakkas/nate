...
(* changed exprs
App (Just (17,20)-(17,44)) (Var (Just (17,20)-(17,26)) "helper") [Lit (Just (17,27)-(17,28)) (LI 0),ConApp (Just (17,29)-(17,41)) "::" (Just (Tuple (Just (17,30)-(17,40)) [Var (Just (17,30)-(17,33)) "num",Var (Just (17,37)-(17,40)) "xs'"])) Nothing,Var (Just (17,42)-(17,44)) "xs"]
