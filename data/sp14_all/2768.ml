...
App (Just (33,9)-(34,69)) (Var (Just (33,9)-(33,21)) "buildAverage") [Tuple (Just (34,11)-(34,69)) [App (Just (34,12)-(34,39)) (Var (Just (34,13)-(34,18)) "build") [Tuple (Just (34,19)-(34,38)) [Var (Just (34,20)-(34,24)) "rand",Bop (Just (34,26)-(34,37)) Minus (Var (Just (34,27)-(34,32)) "depth") (Lit (Just (34,35)-(34,36)) (LI 2))]],App (Just (34,41)-(34,68)) (Var (Just (34,42)-(34,47)) "build") [Tuple (Just (34,48)-(34,67)) [Var (Just (34,49)-(34,53)) "rand",Bop (Just (34,55)-(34,66)) Minus (Var (Just (34,56)-(34,61)) "depth") (Lit (Just (34,64)-(34,65)) (LI 2))]]]]
Bop (Just (34,26)-(34,37)) Minus (Var (Just (34,27)-(34,32)) "depth") (Lit (Just (34,35)-(34,36)) (LI 2))
Var (Just (34,42)-(34,47)) "build"
Tuple (Just (34,48)-(34,67)) [Var (Just (34,49)-(34,53)) "rand",Bop (Just (34,55)-(34,66)) Minus (Var (Just (34,56)-(34,61)) "depth") (Lit (Just (34,64)-(34,65)) (LI 2))]
Var (Just (36,9)-(36,19)) "buildTimes"
Tuple (Just (37,11)-(37,69)) [App (Just (37,12)-(37,39)) (Var (Just (37,13)-(37,18)) "build") [Tuple (Just (37,19)-(37,38)) [Var (Just (37,20)-(37,24)) "rand",Bop (Just (37,26)-(37,37)) Minus (Var (Just (37,27)-(37,32)) "depth") (Lit (Just (37,35)-(37,36)) (LI 2))]],App (Just (37,41)-(37,68)) (Var (Just (37,42)-(37,47)) "build") [Tuple (Just (37,48)-(37,67)) [Var (Just (37,49)-(37,53)) "rand",Bop (Just (37,55)-(37,66)) Minus (Var (Just (37,56)-(37,61)) "depth") (Lit (Just (37,64)-(37,65)) (LI 2))]]]
Lit (Just (37,35)-(37,36)) (LI 2)
App (Just (37,41)-(37,68)) (Var (Just (37,42)-(37,47)) "build") [Tuple (Just (37,48)-(37,67)) [Var (Just (37,49)-(37,53)) "rand",Bop (Just (37,55)-(37,66)) Minus (Var (Just (37,56)-(37,61)) "depth") (Lit (Just (37,64)-(37,65)) (LI 2))]]
Bop (Just (37,55)-(37,66)) Minus (Var (Just (37,56)-(37,61)) "depth") (Lit (Just (37,64)-(37,65)) (LI 2))
