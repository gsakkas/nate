...
Tuple (Just (19,10)-(20,67)) [Bop (Just (19,11)-(19,30)) Plus (App (Just (19,12)-(19,19)) (Var (Just (19,13)-(19,16)) "fst") [Var (Just (19,17)-(19,18)) "x"]) (App (Just (19,22)-(19,29)) (Var (Just (19,23)-(19,26)) "snd") [Var (Just (19,27)-(19,28)) "x"]),List (Just (20,12)-(20,66)) [Bop (Just (20,13)-(20,37)) Div (Bop (Just (20,13)-(20,32)) Plus (App (Just (20,14)-(20,21)) (Var (Just (20,15)-(20,18)) "fst") [Var (Just (20,19)-(20,20)) "x"]) (App (Just (20,24)-(20,31)) (Var (Just (20,25)-(20,28)) "snd") [Var (Just (20,29)-(20,30)) "x"])) (Lit (Just (20,35)-(20,37)) (LI 10)),Bop (Just (20,39)-(20,65)) Mod (Bop (Just (20,39)-(20,58)) Plus (App (Just (20,40)-(20,47)) (Var (Just (20,41)-(20,44)) "fst") [Var (Just (20,45)-(20,46)) "x"]) (App (Just (20,50)-(20,57)) (Var (Just (20,51)-(20,54)) "snd") [Var (Just (20,55)-(20,56)) "x"])) (Lit (Just (20,63)-(20,65)) (LI 10))] Nothing]
App (Just (19,22)-(19,29)) (Var (Just (19,23)-(19,26)) "snd") [Var (Just (19,27)-(19,28)) "x"]
...
Tuple (Just (21,16)-(21,23)) [Lit (Just (21,17)-(21,18)) (LI 0),List (Just (21,20)-(21,22)) [] Nothing]
