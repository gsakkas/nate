...
Var (Just (23,15)-(23,23)) "List.rev"
App (Just (23,24)-(23,44)) (Var (Just (23,25)-(23,37)) "List.combine") [Var (Just (23,38)-(23,40)) "l1",Var (Just (23,41)-(23,43)) "l2"]
*)
...
'a list
'a list
'a -> (int list list * int list list) list
'a -> (int list list * int list list) list
*)
