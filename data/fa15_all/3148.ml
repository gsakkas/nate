...
Var (Just (22,37)-(22,39)) "x1"
Var (Just (22,42)-(22,44)) "x2"
Var (Just (22,48)-(22,50)) "x2"
Let (Just (23,4)-(25,51)) NonRec [(VarPat (Just (23,8)-(23,12)) "base",Tuple (Just (23,15)-(23,23)) [List (Just (23,16)-(23,18)) [] Nothing,List (Just (23,20)-(23,22)) [] Nothing])] (Let (Just (24,4)-(25,51)) NonRec [(VarPat (Just (24,8)-(24,12)) "args",App (Just (24,15)-(24,33)) (Var (Just (24,15)-(24,27)) "List.combine") [Var (Just (24,28)-(24,30)) "l1",Var (Just (24,31)-(24,33)) "l2"])] (Let (Just (25,4)-(25,51)) NonRec [(TuplePat (Just (25,9)-(25,14)) [WildPat (Just (25,9)-(25,10)),VarPat (Just (25,11)-(25,14)) "res"],App (Just (25,18)-(25,44)) (Var (Just (25,18)-(25,32)) "List.fold_left") [Var (Just (25,33)-(25,34)) "f",Var (Just (25,35)-(25,39)) "base",Var (Just (25,40)-(25,44)) "args"])] (Var (Just (25,48)-(25,51)) "res")))
List (Just (23,16)-(23,18)) [] Nothing
