...
(* changed exprs
Case (Just (27,7)-(27,63)) (App (Just (27,13)-(27,24)) (Var (Just (27,13)-(27,17)) "rand") [Tuple (Just (27,18)-(27,24)) [Lit (Just (27,19)-(27,20)) (LI 0),Lit (Just (27,22)-(27,23)) (LI 1)]]) [(LitPat (Just (27,32)-(27,33)) (LI 0),Nothing,App (Just (27,37)-(27,46)) (Var (Just (27,37)-(27,43)) "buildX") [ConApp (Just (27,44)-(27,46)) "()" Nothing (Just (TApp "unit" []))]),(LitPat (Just (27,49)-(27,50)) (LI 1),Nothing,App (Just (27,54)-(27,63)) (Var (Just (27,54)-(27,60)) "buildY") [ConApp (Just (27,61)-(27,63)) "()" Nothing (Just (TApp "unit" []))])]
