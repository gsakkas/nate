...
Case (Just (15,2)-(15,77)) (Var (Just (15,8)-(15,9)) "l") [(ConPat (Just (15,17)-(15,19)) "[]" Nothing,Nothing,List (Just (15,23)-(15,25)) [] Nothing),(ConsPat (Just (15,28)-(15,34)) (VarPat (Just (15,28)-(15,29)) "x") (VarPat (Just (15,31)-(15,34)) "xs'"),Nothing,Ite (Just (15,38)-(15,77)) (Bop (Just (15,41)-(15,46)) Eq (Var (Just (15,41)-(15,42)) "x") (Lit (Just (15,45)-(15,46)) (LI 0))) (App (Just (15,52)-(15,63)) (Var (Just (15,52)-(15,59)) "rmzhelp") [Var (Just (15,60)-(15,63)) "xs'"]) (ConApp (Just (15,69)-(15,77)) "::" (Just (Tuple (Just (15,69)-(15,77)) [Var (Just (15,69)-(15,70)) "x",Var (Just (15,74)-(15,77)) "xs'"])) Nothing))]
Var (Just (15,60)-(15,63)) "xs'"
ConApp (Just (15,69)-(15,77)) "::" (Just (Tuple (Just (15,69)-(15,77)) [Var (Just (15,69)-(15,70)) "x",Var (Just (15,74)-(15,77)) "xs'"])) Nothing
...
Tuple (Just (35,15)-(35,22)) [Lit (Just (35,16)-(35,17)) (LI 0),List (Just (35,19)-(35,21)) [] Nothing]
Var (Just (36,15)-(36,23)) "List.rev"
App (Just (36,24)-(36,44)) (Var (Just (36,25)-(36,37)) "List.combine") [Var (Just (36,38)-(36,40)) "l1",Var (Just (36,41)-(36,43)) "l2"]
*)
